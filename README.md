...
> This is one of the many Capstone Projects included in The Odin Project curriculum

**[ Landing Page ]** is the second Capstone project included in the Foundations Course at the The Odin Project Fullstack Curriculum. This project is aimed to apply all the basic HTML & CSS skills learned in the Foundations course.
...
- https://cuauh-cabrera.github.io/odin-landing/
...
```sh
  cd my-folder
  git@github.com:cuauh-cabrera/odin-landing.git
```
